...
function ThemeToggle({ className = "", compact = false }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 border-2 border-[#5C3A21]/20 bg-[#FAF3E0] px-3 py-2 font-serif text-[10px] font-bold uppercase tracking-[0.15em] text-[#5C3A21] transition-all hover:border-[#2C1810] hover:text-[#2C1810] ${className}`}
    >
